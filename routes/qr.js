                ...
                if (qr && !responseSent) {
                    ...
                    if (!res.headersSent) {
                        res.send(`
                            ...
                            <html>
                            <head>
                                <title>June X Bot | QR CODE</title>
                                ...
                                <style>
                                    body {
                                        ...
                                        min-height: 100vh;
                                        margin: 0;
                                        background: linear-gradient(135deg, #0d0720 0%, #080412 100%);
                                    ...
                                    h1 {
                                        background: linear-gradient(135deg, #a78bfa 0%, #06b6d4 40%, #f59e0b 80%, #ec4899 100%);
